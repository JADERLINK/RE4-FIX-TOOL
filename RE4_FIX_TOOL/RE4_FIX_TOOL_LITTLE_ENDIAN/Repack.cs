...
namespace RE4_FIX_TOOL_LITTLE_ENDIAN
{
            ...
            if (Directory.Exists(ImageFolder)) 
            {
                ...
                if (fixFile != null)
                {
                    ...
                    for (int i = 0; i < iCount; i++)
                    {
                        ...
                        else if (File.Exists(ddspatch)) { imageFile = new FileInfo(ddspatch); }
                        else if (File.Exists(tgapatch)) { imageFile = new FileInfo(tgapatch); }
